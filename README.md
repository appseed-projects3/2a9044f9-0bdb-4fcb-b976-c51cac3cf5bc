...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-04 06:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2a9044f9-0bdb-4fcb-b976-c51cac3cf5bc.git
$ cd 2a9044f9-0bdb-4fcb-b976-c51cac3cf5bc
```
